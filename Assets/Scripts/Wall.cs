...
public class Wall : BaseObjectScene, ISetDamage
{
	...
	public void SetDamage(InfoCollision info)
	{
	    ...
	    //var projectorRotation = Quaternion.FromToRotation(-Vector3.forward, info.Point.normal);
	    //var obj = Instantiate(_projector, info.Point.point + info.Point.normal * 0.25f, projectorRotation, info.ObjCollision); // manager
	    //obj.transform.rotation = Quaternion.Euler(obj.transform.eulerAngles.x, obj.transform.eulerAngles.y, Random.Range(0, 360));
    }
}
